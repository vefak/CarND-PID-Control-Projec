...
int main()
{
  ...
  // start with tau_p, tau_d and tau_i with input parameters
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
		  ...
		  //Used manual turning instead of Twiddle
		  //pid.Twiddle();
		  //std::cout << "\t\t\t\t\t\ttau_p|tau_i|tau_d=" << pid.Kp << "|" << pid.Ki << "|" << pid.Kd << std::endl;
